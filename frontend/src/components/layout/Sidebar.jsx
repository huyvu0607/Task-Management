...
const Sidebar = ({ 
  ...
  return (
    ...
    >
      ...
      {/* New Task Button */}
      <div className="p-4">
        <button className="w-full bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 text-white dark:text-gray-900 rounded-lg py-3 flex items-center justify-center space-x-2 transition-colors shadow-sm">
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex items-center justify-between gap-2">
        ...
        {project.taskCount !== undefined && project.taskCount > 0 && (
          <span className="text-xs text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full font-medium">
            {project.taskCount}
          </span>
        )}
      </div>
