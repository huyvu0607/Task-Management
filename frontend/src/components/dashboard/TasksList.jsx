      ...
      <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="px-4 py-2 bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium rounded-lg transition-colors flex items-center space-x-2">
...
// Header với tiêu đề và số lượng tasks (pending, completed)
// Filter & Sort buttons
// Add Task button
// Danh sách tasks sử dụng component TaskItem
