...
public interface TeamInvitationRepository extends JpaRepository<TeamInvitation, Long> {
    ...
    // Method 2: Find other pending invitations (để auto-cancel)
    List<TeamInvitation> findByTeamIdAndInvitedEmailAndStatusAndIdNot(
            Long teamId,
            String invitedEmail,
            TeamInvitation.InvitationStatus status,
            Long excludeId
    );
    List<TeamInvitation> findByTeamIdAndInvitedEmailAndStatus(
            Long teamId,
            String invitedEmail,
            TeamInvitation.InvitationStatus status
    );

    List<TeamInvitation> findByTeamIdAndInvitedEmail(Long teamId, String invitedEmail);
