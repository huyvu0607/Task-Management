...
public class DashboardController {
    ...
    public ResponseEntity<ApiResponse<DashboardResponseDTO>> getPersonalDashboard(
        ...
        DashboardResponseDTO dashboard = dashboardService.getPersonalDashboard(userId);
    ...
    public ResponseEntity<ApiResponse<MyTasksDTO>> getMyTasks(
        ...
        Long userId = getUserIdFromAuth(authentication);
        MyTasksDTO myTasks = dashboardService.getMyTasks(userId, limit);
    ...
    public ResponseEntity<ApiResponse<TasksCreatedByMeDTO>> getTasksCreatedByMe(
        ...
        Long userId = getUserIdFromAuth(authentication);
        TasksCreatedByMeDTO tasks = dashboardService.getTasksCreatedByMe(userId, limit);
    ...
    public ResponseEntity<ApiResponse<OverdueTasksDTO>> getOverdueTasks(
        ...
        Long userId = getUserIdFromAuth(authentication);
        OverdueTasksDTO tasks = dashboardService.getOverdueTasks(userId, limit);
    ...
    public ResponseEntity<ApiResponse<TasksDueTodayDTO>> getTasksDueToday(
        ...
        Long userId = getUserIdFromAuth(authentication);
        TasksDueTodayDTO tasks = dashboardService.getTasksDueToday(userId, limit);
