...
public class ProjectController {
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> createProject(
        ...
        ProjectDTO project = projectService.createProject(request, userDetails.getId());
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> getProjectById(
        ...
        ProjectDTO project = projectService.getProjectById(id, userDetails.getId());
    ...
    public ResponseEntity<ApiResponse<PageResponse<ProjectDTO>>> getProjectsByTeam(
        ...
        Page<ProjectDTO> projects = projectService.getProjectsByTeamId(
                teamId,
                userDetails.getId(),
                status,
                pageable
    ...
    public ResponseEntity<ApiResponse<List<ProjectDTO>>> getMyProjects(
        ...
        List<ProjectDTO> projects = projectService.getMyProjects(userDetails.getId());
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> updateProject(
        ...
        ProjectDTO project = projectService.updateProject(id, request, userDetails.getId());
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> archiveProject(
        ...
        ProjectDTO project = projectService.archiveProject(id, userDetails.getId());
    ...
    public ResponseEntity<ApiResponse<ProjectDTO>> unarchiveProject(
        ...
        ProjectDTO project = projectService.unarchiveProject(id, userDetails.getId());
    ...
    public ResponseEntity<ApiResponse<Void>> recalculateProgress(
        ...
        projectService.recalculateProgress(id);
    ...
    public ResponseEntity<ApiResponse<ProjectStatsDTO>> getProjectStats(
        ...
        ProjectStatsDTO stats = projectService.getProjectStats(teamId, userDetails.getId());
